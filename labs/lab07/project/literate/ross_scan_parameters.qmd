---
title: "Ross parameter scan"
subtitle: "Machines, spares and repairers"
format:
  html:
    toc: true
execute:
...
Провести серию экспериментов для разного числа машин, резервных машин и ремонтников.
...
Рост числа резервных машин и ремонтников увеличивает среднее время до падения системы. Сканирование параметров позволяет оценить вклад каждого фактора.
